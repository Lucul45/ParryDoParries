...
public class FrameDataManager : Singleton<FrameDataManager>
{
    ...
    public void ChangeFrameDataUI()
    {
        ...
        if (_player1.EnumCurrentState == EPlayerState.IDLE && _player1.LastState == EPlayerState.MELEE && _player2.EnumCurrentState == EPlayerState.IDLE && (_player2.LastState == EPlayerState.HURT || _player2.LastState == EPlayerState.PARRY))
        {
